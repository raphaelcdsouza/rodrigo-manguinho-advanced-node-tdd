...
describe('PgConnection', () => {
  ...
  it('should return TransactionNotFoundError on close transaction if query runner is not found', async () => {
  ...
  it('should return TransactionNotFoundError on commit transaction if query runner is not found', async () => {
  ...
  it('should return TransactionNotFoundError on rollback transaction if query runner is not found', async () => {
  ...
  it('should get repository', async () => {
    ...
    const respository = sut.getRepository(PgUser)

    expect(getRepositorySpy).toHaveBeenCalledWith(PgUser)
    expect(getRepositorySpy).toHaveBeenCalledTimes(1)
    expect(respository).toBe('any_repo')
  ...
  it('should return ConnectionNotFoundError on get repository if connection is not found', () => {
